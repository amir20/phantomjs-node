...
(function() {
  ...
  module.exports = {
    create: function() {
      var arg, args, cb, httpServer, key, options, phantom, ps, sock, value, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      args = [];
      options = {};
      ...
      if ((_ref1 = options.path) == null) {
        options.path = '';
      }
      if ((_ref2 = options.binary) == null) {
        options.binary = options.path + 'phantomjs';
      }
      if ((_ref3 = options.port) == null) {
        options.port = 0;
      }
      if ((_ref4 = options.hostname) == null) {
        options.hostname = 'localhost';
      }
      if ((_ref5 = options.dnodeOpts) == null) {
        options.dnodeOpts = {};
      }
      ps = null;
      phantom = null;
