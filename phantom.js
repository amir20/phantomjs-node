...
(function() {
  var child, dnode, ecstatic, http, phanta, shoe, startPhantomProcess, wrap,
    __slice = [].slice;
  ...
  module.exports = {
    create: function() {
      var args, binary, cb, httpServer, phantom, port, sock, staticServer, _i;
      ...
      phantom = null;
      staticServer = ecstatic(__dirname + '/static');
      httpServer = http.createServer(staticServer);
