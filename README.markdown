...
[![Build Status](https://travis-ci.org/sgentle/phantomjs-node.svg?branch=master)](https://travis-ci.org/sgentle/phantomjs-node) [![NPM version](https://badge.fury.io/js/phantom.svg)](http://badge.fury.io/js/phantom)
